...
// tuỳ chỉnh cấu hình cho Spring chỉ tìm kiếm các bean trong package com.codegym.controller
...
//    Cấu hình file ghi lỗi - Validation
    @Bean
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/classroom-bank-customer-relations");
